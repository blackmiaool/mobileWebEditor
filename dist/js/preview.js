function get_pure_html() {
    ...
    var attrs = ["contenteditable", "ng-repeat", "data-index", "draggable", "ng-style", "ng-dblclick", "ng-click", "dnd-draggable", "dnd-effect-allowed", "dnd-selected", "dnd-list", "dnd-moved", "editor-model", "data-title", "ng-model", "ng-src", "strip-br", "select-non-editable", "ng-href"];
    attrs = attrs.join(" ");
    var classes = ["ng-scope", "ng-pristine", "ng-untouched", "ng-valid", "ng-dirty", "ng-valid-parse"];
